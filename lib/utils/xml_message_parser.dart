...
class XmlMessageParser {
  ...
  /// 解析撤回消息
  static String? parseRevokeMessage(String xmlContent, String? myWxid, String? senderUsername, String? senderDisplayName) {
    try {
  ...
  /// 渲染拍一拍消息（用真实姓名替换wxid）
  static String renderPatMessage(String template, Map<String, String> wxidToName) {
    var result = template;
